...
from Base import Orientation, DrawConfig, Alignment
...
class CrossHairAxis(AxisBase):
    ...
    def draw_grids(self, config: "DrawConfig", painter: QPainter):
        assert isinstance(self.underlying_axis.grid_drawer.data_source, AutoGeneratedAxisDataSource)
    ...
    def draw_labels(self, config: "DrawConfig", painter: QPainter):
        assert isinstance(self.underlying_axis.label_drawer.data_source, AutoGeneratedAxisDataSource)
